...
class Timer:
    ...
    def Update_progress(self,Current_step,Total_steps):                                        # This method more accurately tracks progress with both the steps and the time information it calculates the estimated time as well as the completion percentage
        self.elapsed_time = int(round((time.time() - self.Start_time)))
